...
# THIS FILE RUNS THE GRADUAL NZE SCENARIO WITH 4 NODES 
...
prepare_initial_network(network)
n = pypsa.Network(network)

# Scale demand and costs
scale_demand = {
    2025: 1.060816836,
    2026: 1.033372562,
    2027: 1.027658017,
...
decom = {
2025 : {'BO0 0 OCGT' : 16.84},
2026 : {'BO0 0 OCGT' : 101.13},
2027 : {'BO0 0 OCGT' : 15.99},
2028 : {},
2029 : {'BO0 0 OCGT' : 113.11},
2030 : {'BO0 0 OCGT' : 101.66},
2031 : {},
2032 : {'BO0 0 oil' : 3.34},
2033 : {},
2034 : {},
2035 : {'BO0 0 oil' : 2.2, 'BO0 0 solar' : 5, 'BO0 0 onwind' : 134},
2036 : {'BO0 1 ror': 11.49},
2037 : {'BO0 3 ror': 6.81, 'BO0 0 OCGT' : 57, 'BO0 1 OCGT' : 4.58},
2038 : {'BO0 0 OCGT' : 18.79, 'BO0 1 OCGT' : 4.66},
2039 : {'BO0 0 biomass' : 21},
2040 : {'BO0 0 OCGT' : 105.21, 'BO0 0 oil' : 1.28},
}
...
2029: {},
2030: {},
2031: {'BO0 3 hydro': 2.55},
2032: {},
2033: {},
2034: {},
2035: {},
2036: {'BO0 3 hydro' : 6.23},
2037: {},
2038: {},
2039: {'BO0 3 hydro' : 6.2},
2040: {},
}

# Define emissions reduction targets
start_year = 2024
...
# Function to extend the hydro generators
def extend_hydro_old(n):
    n.add("Generator",
        'BO0 3-6 hydro', # name of the new storage unit --> REAL NAME: UMA
        bus = 'BO0 3',
        carrier = 'ror',
        p_nom = 0,
    ...
    n.add("Generator",
        'BO0 3-7 hydro', # name of the new storage unit --> REAL NAME: PLD
        bus = 'BO0 3',
        carrier = 'ror',
        p_nom = 0,
        marginal_cost = 0.01037,
    ...
    n.add("Generator",
        'BO0 0-1 hydro', # name of the new storage unit --> REAL NAME: JUN
        bus = 'BO0 0',
        carrier = 'ror',
        p_nom = 0,
        marginal_cost = 0.01037,
    ...
    n.add("StorageUnit",
        'BO0 0-2 hydro', # name of the new storage unit --> REAL NAME: SEH
        bus = 'BO0 0',
        carrier = 'hydro',
        p_nom = 0,
