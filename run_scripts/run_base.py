...
# THIS FILE RUNS THE BASE SCENARIO

# Define scenario folder and name for saving results
scen_folder = 'test_runs/test_base'
scen = 'test_BASE'
...
# In config.py, change the value of the variable "weather_year" to the desired year.
...
#scen_folder = 'test_runs/test_base/weather_2018'
#scen = 'test_BASE_WEATHER_2018'
...
# Define scaling factors for demand
scale_demand = {
    2025: 1.060816836,
    2026: 1.033372562,
    2027: 1.027658017,
...
def yearly_changes(n,year):
    ...
    #     scaled_fuel = fuel / scale_cost_sudden[(car, year)]    
...
# Function to extend hydro generation capacity in the network
...
# Loop through the years and apply changes to the network
