...
# THIS FILE RUNS THE GRADUAL SCENARIO WITH SENSITIVITY ANALYSIS ON TECHNOLOGY COSTS
...
scen_folder = 'test_runs/test_gradual/gradual_cost_sensitivity'
scen = 'test_GRADUAL_cost_sensitivity'
